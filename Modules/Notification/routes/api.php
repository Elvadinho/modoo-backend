...
Route::middleware(['auth:api'])->prefix('v1')->group(function () {
    ...
    Route::get('notifications/{notification}', [ApiNotificationController::class, 'show'])->name('notification.show')->whereNumber('notification');
    Route::delete('notifications/{notification}', [ApiNotificationController::class, 'destroy'])->name('notification.destroy')->whereNumber('notification');

    // Custom endpoints
    Route::get('notifications/unread/count', [ApiNotificationController::class, 'unreadCount'])->name('notifications.unread-count');
    Route::post('notifications/{notification}/read', [ApiNotificationController::class, 'markAsRead'])->name('notifications.mark-as-read')->whereNumber('notification');
